...
import { getAgreementById, getAmendAgreement, createAgreementGroup, updateAgreement } from "@/lib/api/services/agreement.service";
import { createAgreementLineItem } from "@/lib/api/services/agreement-line-item.service";
import { queryAgreementLineItemsByAgreement, queryAgreementGroupByAgreement } from "@/lib/api/services/query-ali.service";
                ...
                <div className="form-container">
                    ...
                    {isDealAgreement && (
                        <div className="form-row">
                            ...
                            <textarea
                                value={pppValue}
                                onChange={(e: any) => setPppValue(e.target.value)}
                            />
                        </div>
                    )}
