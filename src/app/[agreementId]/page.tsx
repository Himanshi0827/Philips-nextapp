...
import { queryAgreementLineItemsByAgreement, queryGetAgreementDetails } from "@/lib/api/services/query-ali.service"; //head
import { updateAgreementLineItem, getAgreementLineItemById } from "@/lib/api/services/agreement-line-item.service";
...
setAgreements(filtered_agreements);
  ...
  const handleEdit = (Id: any) => {
    ...
    navigate.push(`/edit/${agreementId}`);
  };
  ...
  return agreements.filter((item: any) => {
    return (
