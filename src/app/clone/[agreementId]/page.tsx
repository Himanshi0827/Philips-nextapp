...
import { createAgreementGroup } from "@/lib/api/services/agreement.service";
...
import { queryAgreementLineItemsByAgreement,queryCheckAgreementGroup } from "@/lib/api/services/query-ali.service";
...
const [agreementPlist, setAgreementPlist] = useState<any[]>([]);
 const [wrapColumns, setWrapColumns] = useState<Record<string, any>>({});
...
const startResize = (e, columnKey) => {
  ...
  return (<AuthGuard><div className="clone-container">
...
<div className="clone-checkbox">
  <label className="clone-label">
    <input
      ...
      onChange={(e: any) => {setCloneGroupSameAsSource(e.target.checked);
